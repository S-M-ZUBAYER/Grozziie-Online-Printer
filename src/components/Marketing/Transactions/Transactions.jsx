    ...
    <>
      <div className="h-[840px]">
        ...
        <div className="mt-3 mb-[7px] grid grid-cols-10">
          ...
          {/* right side */}
          <div className="bg-white rounded-[17px] shadow-[6px 9px 16.4px 0px rgba(0, 0, 0, 0.04)] px-3 pt-3 col-span-8 pb-4">
            {/* top */}
            ...
            {/* middle table */}
            <div className="mt-4">
              <div className="max-w-[840px] overflow-x-auto">
                <table className="table">
                  <thead className="bg-[#0043681A] bg-opacity-80 h-9 rounded-xl ">
                    <tr className=" text-black text-opacity-80 capitalize text-center text-sm font-light">
                      <th className="sticky top-0 bg-gray-200 flex justify-between">
                        <span className="mr-[6px] font-normal text-xs">
                          Buyer Name
                        </span>
                        <div className="absolute h-8 my-auto top-0 bottom-0 right-0 w-[1px] bg-white mx-1"></div>
                      </th>
                      ...
                      <th className="sticky top-0 bg-gray-200  font-normal text-xs">
                        Product Details
                      </th>
                    </tr>
                  </thead>
                  <tbody className="max-h-[590px] overflow-y-auto">
                    {selectedClient && (
                      ...
                      >
                        {/* buyer Name */}
                        <td className="text-black text-xs font-light capitalize">
                        ...
                        <td className="flex items-center">
                          <span className="text-black text-xs font-light capitalize">
                    ...
                    >
                      ...
                      <td className="flex">
                        xi'an, China
                        <BiSolidEdit className="w-5 h-6 text-[#004368] text-opacity-[0.60] ml-2" />
                      </td>
                      <td className="text-black text-xs font-light capitalize">
                        Remark
                      </td>
                      ...
                      <td className="flex items-center justify-between">
                        <div className="flex items-center gap-1">
                          <img src={TP874} alt="Product" className="w-10 h-8" />
                          <span className="text-black text-xs font-light capitalize">
                            TP874
                          </span>
                        </div>
                        <span className="ml-16 text-[#004368]">Details</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
